 ...
 *--------------------------------------------------------------------------
 *
 * coupled_OscillatorOQS_ForceOLD.h
 * 
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */

#ifndef __COUPLED_OSCILLATOR_OQS_FORCE_OLD_H
#define __COUPLED_OSCILLATOR_OQS_FORCE_OLD_H
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD Definitions
//********************************************************************

// Model name
#define __OQS_OLD_NAME                        "OscOQS_ForceOLD"
// Noise
// #define __OQS_OLD_PARAM_SIGMA                 "param_Osc_OQS_Force_OLD_sigma"
// #define __OQS_OLD_SIGMA                       0.05


//********************************************************************
// coupled_OscillatorOQS_ForceOLD Class
//********************************************************************
template <class P_V, class P_M>
  class coupled_OscillatorOQS_ForceOLD : public uqModel<P_V,P_M>
{

 public:

  coupled_OscillatorOQS_ForceOLD( const uqBaseEnvironmentClass& env );
  coupled_OscillatorOQS_ForceOLD( const uqBaseEnvironmentClass& env, 
			       std::string modelName );
  virtual ~coupled_OscillatorOQS_ForceOLD();
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::coupled_OscillatorOQS_ForceOLD
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceOLD<P_V,P_M>::
  coupled_OscillatorOQS_ForceOLD( const uqBaseEnvironmentClass& env )
  : uqModel<P_V,P_M>( env, __OQS_OLD_NAME )
  {
...
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceOLD<P_V,P_M>::~coupled_OscillatorOQS_ForceOLD()
{}

//********************************************************************
// coupled_OscillatorOQS_ForceOLD::my_forward_problem
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::my_noise_covariance_matrix
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::
			      ...
			      std::map<std::string, double>& map_act_params ) const
{
  ...
  //  double param_sigma = map_act_params[ __OQS_OLD_PARAM_SIGMA ];
  //  covMat(0,0) = pow( param_sigma, 2.0 );

  // 3. compute it as a % from predicted values

  // 4. use a fixed value
  //  covMat(0,0) = pow( __OQS_OLD_SIGMA, 2.0 );
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::my_qoi_model
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::add_spec_params
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::add_spec_params_in_order()
{
  ...
  // specific params
  //  addParam( __OQS_OLD_PARAM_SIGMA );

}

//********************************************************************
// coupled_OscillatorOQS_ForceOLD::add_spec_observables_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::add_spec_observables_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::add_spec_qois_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::add_spec_qois_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceOLD::add_spec_scenarios
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceOLD<P_V,P_M>::add_spec_scenarios_in_order()
{
...
#endif // __COUPLED_OSCILLATOR_OQS_FORCE_OLD_H
