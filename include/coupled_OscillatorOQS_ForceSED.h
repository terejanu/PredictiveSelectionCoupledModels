 ...
 *--------------------------------------------------------------------------
 *
 * coupled_OscillatorOQS_ForceSED.h
 * 
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */

#ifndef __COUPLED_OSCILLATOR_OQS_FORCE_SED_H
#define __COUPLED_OSCILLATOR_OQS_FORCE_SED_H
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED Definitions
//********************************************************************

// Model name
#define __OQS_SED_NAME                        "OscOQS_ForceSED"
// Noise
// #define __OQS_SED_PARAM_SIGMA                 "param_Osc_OQS_Force_SED_sigma"
// #define __OQS_SED_SIGMA                       0.05


//********************************************************************
// coupled_OscillatorOQS_ForceSED Class
//********************************************************************
template <class P_V, class P_M>
  class coupled_OscillatorOQS_ForceSED : public uqModel<P_V,P_M>
{

 public:

  coupled_OscillatorOQS_ForceSED( const uqBaseEnvironmentClass& env );
  coupled_OscillatorOQS_ForceSED( const uqBaseEnvironmentClass& env, 
			       std::string modelName );
  virtual ~coupled_OscillatorOQS_ForceSED();
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::coupled_OscillatorOQS_ForceSED
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceSED<P_V,P_M>::
  coupled_OscillatorOQS_ForceSED( const uqBaseEnvironmentClass& env )
  : uqModel<P_V,P_M>( env, __OQS_SED_NAME )
  {
...
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceSED<P_V,P_M>::~coupled_OscillatorOQS_ForceSED()
{}

//********************************************************************
// coupled_OscillatorOQS_ForceSED::my_forward_problem
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::my_noise_covariance_matrix
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::
			      ...
			      std::map<std::string, double>& map_act_params ) const
{
  ...
  //  double param_sigma = map_act_params[ __OQS_SED_PARAM_SIGMA ];
  //  covMat(0,0) = pow( param_sigma, 2.0 );

  // 3. compute it as a % from predicted values

  // 4. use a fixed value
  //  covMat(0,0) = pow( __OQS_SED_SIGMA, 2.0 );
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::my_qoi_model
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::add_spec_params
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::add_spec_params_in_order()
{
  ...
  // specific params
  //  addParam( __OQS_SED_PARAM_SIGMA );

}

//********************************************************************
// coupled_OscillatorOQS_ForceSED::add_spec_observables_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::add_spec_observables_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::add_spec_qois_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::add_spec_qois_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceSED::add_spec_scenarios
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSED<P_V,P_M>::add_spec_scenarios_in_order()
{
...
#endif // __COUPLED_OSCILLATOR_OQS_FORCE_SED_H
