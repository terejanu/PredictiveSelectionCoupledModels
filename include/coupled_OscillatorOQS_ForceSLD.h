 ...
 *--------------------------------------------------------------------------
 *
 * coupled_OscillatorOQS_ForceSLD.h
 * 
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */

#ifndef __COUPLED_OSCILLATOR_OQS_FORCE_SLD_H
#define __COUPLED_OSCILLATOR_OQS_FORCE_SLD_H
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD Definitions
//********************************************************************

// Model name
#define __OQS_SLD_NAME                        "OscOQS_ForceSLD"
// Noise
// #define __OQS_SLD_PARAM_SIGMA                 "param_Osc_OQS_Force_SLD_sigma"
// #define __OQS_SLD_SIGMA                       0.05


//********************************************************************
// coupled_OscillatorOQS_ForceSLD Class
//********************************************************************
template <class P_V, class P_M>
  class coupled_OscillatorOQS_ForceSLD : public uqModel<P_V,P_M>
{

 public:

  coupled_OscillatorOQS_ForceSLD( const uqBaseEnvironmentClass& env );
  coupled_OscillatorOQS_ForceSLD( const uqBaseEnvironmentClass& env, 
			       std::string modelName );
  virtual ~coupled_OscillatorOQS_ForceSLD();
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::coupled_OscillatorOQS_ForceSLD
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceSLD<P_V,P_M>::
  coupled_OscillatorOQS_ForceSLD( const uqBaseEnvironmentClass& env )
  : uqModel<P_V,P_M>( env, __OQS_SLD_NAME )
  {
...
//********************************************************************
template <class P_V, class P_M>
  coupled_OscillatorOQS_ForceSLD<P_V,P_M>::~coupled_OscillatorOQS_ForceSLD()
{}

//********************************************************************
// coupled_OscillatorOQS_ForceSLD::my_forward_problem
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::my_noise_covariance_matrix
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::
			      ...
			      std::map<std::string, double>& map_act_params ) const
{
  ...
  //  double param_sigma = map_act_params[ __OQS_SLD_PARAM_SIGMA ];
  //  covMat(0,0) = pow( param_sigma, 2.0 );

  // 3. compute it as a % from predicted values

  // 4. use a fixed value
  //  covMat(0,0) = pow( __OQS_SLD_SIGMA, 2.0 );
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::my_qoi_model
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::add_spec_params
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::add_spec_params_in_order()
{
  ...
  // specific params
  //  addParam( __OQS_SLD_PARAM_SIGMA );

}

//********************************************************************
// coupled_OscillatorOQS_ForceSLD::add_spec_observables_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::add_spec_observables_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::add_spec_qois_in_order
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::add_spec_qois_in_order()
{
...
//********************************************************************
// coupled_OscillatorOQS_ForceSLD::add_spec_scenarios
//********************************************************************
template <class P_V, class P_M>
  void coupled_OscillatorOQS_ForceSLD<P_V,P_M>::add_spec_scenarios_in_order()
{
...
#endif // __COUPLED_OSCILLATOR_OQS_FORCE_SLD_H
