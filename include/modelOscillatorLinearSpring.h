 ...
 *--------------------------------------------------------------------------
 *
 * modelOscillatorLinearSpring.h
 * 
 *--------------------------------------------------------------------------
 *-------------------------------------------------------------------------- */

#ifndef __MODEL_OSCILLATOR_LINEAR_SPRING_H
#define __MODEL_OSCILLATOR_LINEAR_SPRING_H
...
//********************************************************************
// modelOscillatorLinearSpring : Definitions
//********************************************************************

// Model name
#define __OLS_NAME                        "OscOLS"
// Noise
#define __OLS_PARAM_SIGMA                 "param_Osc_OLS_sigma"
// #define __OLS_SIGMA                       0.1


//********************************************************************
// modelOscillatorLinearSpring Class
//********************************************************************
template <class P_V, class P_M>
  class modelOscillatorLinearSpring : public uqModel<P_V,P_M>
{

 public:

  modelOscillatorLinearSpring( const uqBaseEnvironmentClass& env );
  modelOscillatorLinearSpring( const uqBaseEnvironmentClass& env, 
			       std::string modelName );
  virtual ~modelOscillatorLinearSpring();
...
//********************************************************************
// modelOscillatorLinearSpring::modelOscillatorLinearSpring
//********************************************************************
template <class P_V, class P_M>
  modelOscillatorLinearSpring<P_V,P_M>::
  modelOscillatorLinearSpring( const uqBaseEnvironmentClass& env )
  : uqModel<P_V,P_M>( env, __OLS_NAME )
  {
...
//********************************************************************
template <class P_V, class P_M>
  modelOscillatorLinearSpring<P_V,P_M>::~modelOscillatorLinearSpring()
{}

//********************************************************************
// modelOscillatorLinearSpring::my_forward_problem
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::
...
//********************************************************************
// modelOscillatorLinearSpring::my_noise_covariance_matrix
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::
			      ...
			      std::map<std::string, double>& map_act_params ) const
{
  ...
  double param_sigma = map_act_params[ __OLS_PARAM_SIGMA ];
  covMat(0,0) = pow( param_sigma, 2.0 ) + pow( __OSCILLATOR_MIN_SIGMA, 2.0 );

  // 3. compute it as a % from predicted values

  // 4. use a fixed value
  //  covMat(0,0) = pow( __OLS_SIGMA, 2.0 );

}

//********************************************************************
// modelOscillatorLinearSpring::my_qoi_model
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::
		...
		std::map<std::string, double>& map_act_params ) const
{
  ...
  oscillatorLinearSpring_qoi<P_V,P_M>( qoiPredVec, 
				       map_scn,
				       map_act_params );
...
//********************************************************************
// modelOscillatorLinearSpring::add_spec_params
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::add_spec_params_in_order()
{
...
//********************************************************************
// modelOscillatorLinearSpring::add_spec_observables_in_order
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::add_spec_observables_in_order()
{
...
//********************************************************************
// modelOscillatorLinearSpring::add_spec_qois_in_order
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::add_spec_qois_in_order()
{
...
//********************************************************************
// modelOscillatorLinearSpring::add_spec_scenarios
//********************************************************************
template <class P_V, class P_M>
  void modelOscillatorLinearSpring<P_V,P_M>::add_spec_scenarios_in_order()
{
...
#endif // __MODEL_OSCILLATOR_LINEAR_SPRING_H
